...
title = "What Is The Difference Between LEGAL And LAWFUL?"
date = "2014-05-05"
description = "All that is “legal” relies on belief.  Legal has nothing to do with right and wrong.  It always has to do with money."
tags = [
    "#WhoAmI",
    "#Jurisprudence",
    "#ScottIsAlwaysRight",
...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="/img/fractal.gif" class="d-block w-100" alt="...">
    </div>
  </div>
</div>
...
---
<p><a class="" href="https://web.archive.org/web/20190528020957/https://kentbarrett.com/what-is-the-difference-between-legal-and-lawful/" targt="_blank">[Kent Barrett]</a></p>